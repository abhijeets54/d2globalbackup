...
const customStyles = `
  ...
  .hexagon-logo {
    ...
    align-items: center;
    box-shadow: 0 10px 20px rgba(0, 0, 0, 0.7), 0 6px 6px rgba(0, 0, 0, 0.5), inset 0 -5px 10px rgba(0, 0, 0, 0.3);
    z-index: 20;
...
function Header() {
  ...
  const navItems = [
    ...
    { name: 'Study Abroad', slug: '/StudyAbroad', dropdown: [
    ...
    { name: 'Language Coaching', slug: '/Training', dropdown: [
            ...
            <div className="flex flex-col items-center space-y-2 mt-2 md:mt-0">
              <div className="flex space-x-4">
                <div className="flex items-center">
                  ...
                  <a href="mailto:info@d2global.com" className="text-xs">info@d2global.com</a>
                </div>
                <div className="flex items-center">
                  <FaPhone className="text-sm mr-1 rotate-90" />
                  <a href="tel:+919878990455" className="text-xs">+91 98789 90455</a>
                </div>
              </div>
              ...
              <li key={item.name}>
                ...
                {item.dropdown && activeDropdown === index && (
                  <>
                    ...
                    <button onClick={() => toggleDropdown(index)} className="text-customYellow px-3 py-1 text-xs">
                      Close
                    </button>
                  </>
                )}
