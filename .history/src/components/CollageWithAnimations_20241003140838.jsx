    ...
    <div className="relative w-full h-screen flex flex-col lg:flex-row items-center justify-center bg-gradient-to-r from-gray-50 via-gray-100 to-white">
      ...
      <div className="w-full flex justify-center mt-8">
        <div className="flex space-x-8">
          <img src="/logo1.png" alt="Partner 1" className="h-12 w-12" />
          <img src="/logo2.png" alt="Partner 2" className="h-12 w-12" />
          <img src="/logo3.png" alt="Partner 3" className="h-12 w-12" />
