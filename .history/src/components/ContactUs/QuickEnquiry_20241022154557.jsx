        ...
        <div className="p-4 sm:p-6 flex-grow flex flex-col justify-between">
          ...
          <form onSubmit={handleSubmit} ref={form} className="space-y-2 sm:space-y-3 flex-grow flex flex-col justify-between">
            ...
            <div className="text-center mt-2 sm:mt-4">
              <button 
                className={`bg-blue-950 text-yellow-400 py-2 px-4 rounded text-sm sm:text-base hover:bg-blue-800 transition-colors duration-300 ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`} 
                type="submit" 
                disabled={isLoading}
              >
          ...
          {/* Success Message */}
          {successMessage && (
            <div className="mt-4 text-center text-green-500 text-sm sm:text-base">
              {successMessage}
            </div>
          )}
          {/* Error Message */}
          {errorMessage && (
            <div className="mt-4 text-center text-red-500 text-sm sm:text-base">
              {errorMessage}
            </div>
          )}
        </div>
