...
const ContactUs = () => {
  return (
    <footer className="bg-customBlue text-customYellow py-8">
      <div className="container mx-px grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-lg">
        ...
        <div className="flex items-center justify-center space-x-4">
          ...
          <div className="flex flex-col">
            ...
            <Link to="/AboutUs" className="text-gray-400 hover:text-customYellow font-openSans">
              About
            </Link>
            <Link to="/Partners" className="text-gray-400 hover:text-customYellow font-openSans">
              Partner with us
            </Link>
          </div>
        </div>
        ...
        <div className="space-y-4 text-center md:text-left">
          ...
          <div className="flex flex-col space-y-2">
            <Link to="/StudyAbroad" className="text-gray-400 hover:text-customYellow font-openSans">
              Study Abroad
            </Link>
            <Link to="/TouristVisa" className="text-gray-400 hover:text-customYellow font-openSans">
              Tourist Visa
            </Link>
            <Link to="/ContactUs" className="text-gray-400 hover:text-customYellow font-openSans">
              Contact Us
            </Link>
            <Link to="/PR" className="text-gray-400 hover:text-customYellow font-openSans">
              Permanent Residency
            </Link>
          </div>
        </div>
