  ...
  return (
    <div className="study-usa-container">
      ...
      <div className="bg-white p-10 flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="lg:w-1/2">
          <h1 className="text-4xl font-bold flex items-center mb-6">
            <img src="/usaflag.webp" alt="USA Flag" className="w-8 h-8 mr-2" /> 
            Study in USA
          </h1>
          ...
          <div className="flex justify-start space-x-10 text-center">
            <div>
              <h3 className="text-3xl font-bold text-red-600">280 +</h3>
              <p>Academic Institutions</p>
            </div>
            <div>
              <h3 className="text-3xl font-bold text-red-600">24000 +</h3>
              <p>Programs</p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:w-1/2 mt-6 lg:mt-0 flex justify-center">
          <img src="/usa1.webp" alt="Study in USA" className="w-full max-w-md rounded-lg shadow-lg" />
        </div>
      </div>

      {/* Why study in USA */}
      <div className="bg-blue-950 text-white p-10">
        <h2 className="text-3xl font-bold mb-4">Why Study in USA</h2>
        <h3 className="text-2xl font-semibold mb-10">The ultimate destination for all academic, technical, and professional developments.</h3>
      ...
      <div className="bg-gray-100 p-10">
        <h2 className="text-3xl font-bold mb-6">Top Universities of USA</h2>
        ...
        <h3 className="text-2xl font-semibold mb-4 mt-6">English Requirements</h3>
