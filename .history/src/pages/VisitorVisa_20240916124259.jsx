    ...
    <div className="bg-gray-100 py-10 px-5 md:px-20">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
        ...
        <motion.div 
          ...
          transition={{ duration: 0.3 }}
        >
          <h2 className="text-2xl font-bold text-blue-800">Types of Visitor Visas</h2>
          <ul className="mt-4 space-y-2 text-gray-700">
            <li>Tourist Visa</li>
            <li>Business Visa</li>
            <li>Medical Visa</li>
        ...
        <motion.div 
          ...
          transition={{ duration: 0.3 }}
        >
          <h2 className="text-2xl font-bold text-blue-800">Countries We Cover</h2>
          <ul className="mt-4 space-y-2 text-gray-700">
            <li>United States</li>
      ...
      <section className="mt-16">
        <motion.h2 
          className="text-center text-3xl font-bold text-blue-800"
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.3 }}
          >
            <h3 className="text-xl font-semibold text-blue-700">United States</h3>
          ...
          <motion.div 
            ...
            transition={{ duration: 0.3 }}
          >
            <h3 className="text-xl font-semibold text-blue-700">United Kingdom</h3>
            <ol className="mt-4 list-decimal list-inside space-y-1 text-gray-700">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.3 }}
          >
            <h3 className="text-xl font-semibold text-blue-700">Canada</h3>
            <ol className="mt-4 list-decimal list-inside space-y-1 text-gray-700">
      ...
      >
        <motion.button 
          className="px-8 py-3 bg-blue-600 text-white font-bold rounded-full shadow-lg hover:bg-blue-700 transition duration-300"
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.9 }}
        >
          Get Your Visitor Visa Today!
        </motion.button>
      </motion.div>
    </div>
  );
