...
const WorldMapContact = () => {
  ...
  return (
    <div 
      className="h-[1500px] bg-cover bg-center bg-no-repeat relative overflow-hidden" 
      style={{ backgroundImage: 'url(/register/form1.webp)' }}
    >
      <div className="absolute inset-0 bg-black bg-opacity-50" />
      <div className="relative h-full max-w-7xl mx-auto flex items-center justify-end px-4">
        {/* Left side text */}
        <div className="w-1/3 pr-8 hidden md:block">
        ...
        <motion.div
          ...
          className="w-full md:w-2/3 bg-white bg-opacity-95 rounded-xl shadow-lg p-6 ml-8 max-h-[80%]"
        >
          <h1 className="text-2xl font-bold text-center mb-8">Select Your Destination</h1>

          <div className="relative">
            <svg viewBox="0 0 1200 600" className="w-full h-[500px]" preserveAspectRatio="xMidYMid meet">
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{
                  backgroundImage: 'url(/register/map-preview.png)',
