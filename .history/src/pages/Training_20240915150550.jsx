...
const Training = () => {
  ...
  return (
    <div className="bg-gray-100 py-10 px-4 sm:px-6 lg:px-8">
      ...
      >
        <h1 className="text-3xl sm:text-4xl font-bold text-indigo-600 mb-4">IELTS, PTE & Spoken English Training</h1>
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
      >
        <h2 className="text-2xl font-bold text-indigo-600 mb-4">IELTS Training</h2>
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
      >
        <h2 className="text-2xl font-bold text-indigo-600 mb-4">PTE Training</h2>
        <p className="text-gray-700 mb-4">
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
      >
        <h2 className="text-2xl font-bold text-indigo-600 mb-4">Spoken English Training</h2>
        <p className="text-gray-700 mb-4">
      ...
      <motion.div
        className="bg-indigo-600 text-white p-8 rounded-lg mb-8"
        initial={{ scale: 0.9, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        transition={{ duration: 1 }}
      >
        <h3 className="text-2xl font-bold mb-4">Why Choose D2 Global Immigration?</h3>
        <ul className="list-disc list-inside text-white text-lg">
          <li>Expert trainers with years of experience in IELTS, PTE, and Spoken English.</li>
          <li>Customized learning plans tailored to individual student needs.</li>
          <li>Comprehensive study materials and practice tests.</li>
          <li>State-of-the-art training facilities with the latest technology.</li>
          <li>Small batch sizes for focused attention and personal guidance.</li>
        </ul>
      </motion.div>
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
      >
        <h3 className="text-2xl font-bold text-indigo-600">Take the Next Step!</h3>
        <p className="text-gray-700 mb-6">Enroll in D2 Global Immigration's training programs and unlock your future opportunities abroad.</p>
