...
import animationData from './path/to/your/lottie-animation.json'; // Update with your animation JSON path
  ...
  return (
    <div className="relative w-full h-screen flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 bg-gradient-to-r from-gray-50 via-gray-100 to-white">
      ...
      <div className="absolute top-10 left-1/2 transform -translate-x-1/2 z-10">
        <Lottie animationData={animationData} loop={true} style={{ width: 200, height: 200 }} /> {/* Adjust width and height as needed */}
      </div>
