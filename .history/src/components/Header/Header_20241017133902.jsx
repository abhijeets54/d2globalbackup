  ...
  return (
    <>
      ...
      <header className="bg-customBlue text-customYellow relative shadow-md">
        <Container>
          <div className="flex flex-col lg:flex-row justify-between items-center relative py-2 min-h-[80px]">
            
            {/* Logo and Company Name */}
            <div className="flex items-center relative flex-shrink-0 w-full lg:w-auto mb-4 lg:mb-0">
              {/* Hexagon Logo container */}
              <div className="hexagon-logo absolute w-[100px] h-[115px] bg-[#051b38] top-8 left-4 lg:left-20 flex justify-center items-center shadow-lg z-20">
