...
const WorldMapContact = () => {
  ...
  const countries = {
    UK: { x: 540, y: 100, name: 'United Kingdom' },
  ...
  return (
    ...
    >
      ...
      <div className="relative h-full max-w-7xl mx-auto flex items-center  px-4 justify-end">
        {/* Left side text */}
        ...
        <motion.div
          ...
          className="w-full max-w-[900px] bg-white bg-opacity-95 rounded-xl shadow-lg p-6 ml-8"
        >
              ...
              {Object.entries(countries).map(([code, { x, y, name }], index) => (
                ...
                >
                  ...
                  <text
                    ...
                    y={y - 16}
                    textAnchor="middle"
                    className="text-lg font-bold fill-gray-800"  // Larger and bolder text
                  >
                    {name}
                  </text>
                </motion.g>
