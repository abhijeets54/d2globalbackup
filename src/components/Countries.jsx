...
function Countries() {
  const canadaImageUrl = '/canada.jpg'; // Update with actual image URL
  const australiaImageUrl = '/aus.jpg'; // Update with actual image URL
  const newZealandImageUrl = '/nz.jpg'; // Update with actual image URL
  const ukImageUrl = '/uk.jpg'; // Update with actual image URL
