  ...
  return (
    ...
    <QuickEnquiry/>
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
      >
        <h2 className="text-2xl font-bold ">Spoken English Training</h2>
        <p className=" mb-4">
      ...
      >
        ...
        <p className="text-gray-700 ">Enroll in D2 Global Immigration's training programs and unlock your future opportunities abroad.</p>
        <br />
      </motion.div>
