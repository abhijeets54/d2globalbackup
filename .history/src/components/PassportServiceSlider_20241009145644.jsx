  ...
  return (
    <div className="relative w-full h-[500px] overflow-hidden">
      {slides.map((slide, index) => (
        ...
        >
          <div className="absolute inset-0 flex flex-col items-left justify-start p-8">
            <div className="w-full md:w-1/2 text-black">
              ...
              <button className="bg-customBlue text-white px-6 py-2 rounded-full hover:bg-blue-700 animate-fadeInUp animation-delay-400">
                {slide.buttonText}
              </button>
            </div>
          </div>
