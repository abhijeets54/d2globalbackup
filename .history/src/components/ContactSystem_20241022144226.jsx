                ...
                <div className="md:w-1/3 bg-gradient-to-b from-blue-600 to-blue-800 p-8 text-white">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <div className="flex items-center mb-3">
                        <FaMapMarkerAlt className="text-xl mr-2" />
                        <p className="font-semibold">Second Branch</p>
                      </div>
                      <p className="text-sm ml-7 leading-relaxed">
                  ...
                  <form className="space-y-4" onSubmit={handleSubmit} ref={form}>
                    ...
                    <div className="text-center">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="bg-blue-600 text-white py-3 px-8 rounded-lg text-sm font-semibold flex items-center justify-center mx-auto transition duration-300 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                        type="submit"
                      >
