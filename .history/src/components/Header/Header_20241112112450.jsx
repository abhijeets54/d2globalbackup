                          ...
                          {item.dropdown.map((subItem) => (
                            <li key={subItem.name} className="relative sub-dropdown">
                              <a
                                ...
                                className={`block px-3 py-2 w-full text-left text-sm hover:bg-blue-900 transition-colors duration-150 ${
                                  ...
                                  {subItem.subDropdown.map((subSubItem) => (
                                    <li key={subSubItem.name}>
                                      <a
                                        ...
                                        className={`block px-4 py-2 w-full text-left text-sm hover:bg-blue-900 transition-colors duration-150 ${
                    ...
                    {item.dropdown.map((subItem) => (
                      <li key={subItem.name}>
                        <a
                          href={subItem.slug}
                          onClick={(e) => handleNavigation(e, subItem.slug)}
                          className={`block px-6 py-2 w-full text-left text-sm hover:bg-blue-800 ${
                            location.pathname === subItem.slug ? 'font-bold' : ''
                          }`}
                        >
                          {subItem.name}
