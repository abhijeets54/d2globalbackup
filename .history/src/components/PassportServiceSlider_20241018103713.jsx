...
>
  ...
  <div className="absolute inset-0 bg-black bg-opacity-50 z-20"></div> {/* Lower z-index */}
</div>
...
>
  <div className="w-full md:w-1/2 text-white space-y-4">
    ...
    <button
      ...
      className="px-6 py-3 bg-customBlue text-white font-semibold rounded-md hover:bg-customYellow transition duration-300 z-40" // Add z-40 to button
    >
      {slide.buttonText}
    </button>
  </div>
