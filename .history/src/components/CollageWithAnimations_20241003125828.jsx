...
const CollageWithAnimations = () => {
  ...
  useEffect(() => {
    ...
    const startTyping = () => {
      ...
      // Ensure the text exists before typing
      if (texts[textIndex]) {
    ...
    startTyping(); // Start typing on component mount
    return () => clearInterval(typingInterval); // Clean up interval on unmount
  }, [textIndex]); // Restart typing when textIndex changes
      ...
      <div className="w-full lg:w-1/2 text-center lg:text-left mt-8 lg:mt-0">
        ...
        <h2 className="text-2xl md:text-3xl lg:text-5xl font-semibold mt-4">
          <span className="text-red-500">
            {displayedText || texts[textIndex]} {/* Fallback for when typing hasn't started */}
          </span>
        </h2>
        <button
