    ...
    >
      ...
      <div className="relative h-full max-w-7xl mx-auto flex items-center px-4 justify-items-end flex-col md:flex-row">
        ...
        <motion.div
          ...
          className="w-full md:w-2/3 max-w-[1100px] bg-white bg-opacity-95 rounded-xl shadow-lg p-6 mt-6 md:mt-0 ml-0 md:ml-8"
        >
              ...
              {Object.entries(countries).map(([code, { x, y, name }], index) => (
                ...
                >
                  ...
                  <text
                    ...
                    y={y - 16}
                    textAnchor="middle"
                    className="text-xl font-bold custom-font-class"  // Use your custom font class here
                  >
                    {name}
                  </text>
                </motion.g>
