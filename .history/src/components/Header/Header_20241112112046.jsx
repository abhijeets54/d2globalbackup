        ...
        <Container>
          <div className="flex flex-col lg:flex-row justify-between items-center relative min-h-[80px]">
            ...
            <div className="flex flex-col items-center lg:items-end space-y-2">
              <div className="flex space-x-4 mr-8 md:mr-20 lg:mr-44 xl:mr-64 text-sm font-openSans">
                ...
                <ul className="flex space-x-4">
                  {navItems.map((item) => (
                    <li key={item.name} className="relative dropdown-hover">
                      ...
                      {/* Main Dropdown */}
                      {item.dropdown && (
                        <ul className="hidden absolute right-0 mt-1 w-40 bg-customBlue shadow-lg z-50 text-customYellow font-mukta">
                          {item.dropdown.map((subItem) => (
                            <li key={subItem.name} className="relative dropdown-hover">
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
                              ...
                              {/* Sub Dropdown */}
                              {subItem.subDropdown && (
                                <ul className="hidden absolute left-full top-0 w-40 bg-customBlue shadow-lg z-50 font-mukta">
            ...
            {/* Mobile menu button and menu remain unchanged */}
