    ...
    <footer className="bg-customBlue text-customYellow py-8">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-lg">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex flex-col">
              ...
              <div className="space-y-2 text-center md:text-left">
                ...
                <Link to="/Partners" className="text-gray-400 hover:text-customYellow font-openSans">Partner with Us</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 text-center md:text-left">
          ...
          <Link to="/Study" className="text-gray-400 hover:text-customYellow font-openSans">Study Abroad</Link> <br />
