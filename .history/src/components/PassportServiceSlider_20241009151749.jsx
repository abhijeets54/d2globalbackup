...
const PassportServiceSlider = () => {
  ...
  const handleButtonClick = (path) => {
    // Ensure the navigate works properly
    console.log('Navigating to:', path); // Debugging line to check if the event is triggered
    navigate(path); // Ensure this is linked to your React Router paths
  };
      ...
      {slides.map((slide, index) => (
        ...
        >
          <div className="absolute inset-0 flex flex-col items-left justify-center p-8">
            <div className="w-full md:w-1/2 text-black relative z-20">
              ...
              <button 
                ...
                className="bg-customBlue text-white px-6 py-2 rounded-full hover:bg-blue-700 animate-fadeInUp animation-delay-400 relative z-30"
              >
                {slide.buttonText}
              </button>
            </div>
