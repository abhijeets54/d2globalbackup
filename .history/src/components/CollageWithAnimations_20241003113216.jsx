  ...
  return (
    <div className="relative w-full h-screen bg-white flex items-center justify-between px-6 md:px-12">
      ...
      <div className="relative">
        ...
        <motion.div
          className="absolute top-0 left-0 p-4 bg-gradient-to-r from-customBlue to-customYellow rounded-lg text-white"
          animate={{ y: [0, -10, 0] }}
        ...
        {/* Box: Bottom-right of the image */}
        <motion.div
          className="absolute bottom-0 right-0 p-4 bg-gradient-to-r from-customBlue to-customYellow rounded-lg text-white"
          animate={{ y: [0, -10, 0] }}
