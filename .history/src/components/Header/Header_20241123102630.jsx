      ...
      <header className="bg-customBlue text-customYellow relative shadow-md">
        <Container>
          <div className="flex flex-col lg:flex-row justify-between items-center relative min-h-[80px]">
            ...
            {/* Contact Info - Moved to top left */}
            <div className="absolute top-2 left-40 lg:left-48 z-10">
              <div className="flex space-x-4 text-sm font-openSans">
            ...
            <div className="flex items-center relative flex-shrink-0 w-full lg:w-auto mb-4 lg:mb-0">
              ...
              <div className="ml-16 md:ml-24 lg:ml-40 xl:ml-48 text-left px-4 mb-2">
                <div className="text-3xl font-bold font-poppins text-customYellow mt-8">D2 Global</div>
              </div>
            </div>
