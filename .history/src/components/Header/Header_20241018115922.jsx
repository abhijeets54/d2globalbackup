        ...
        <Container>
          <div className="flex flex-col lg:flex-row justify-between items-center relative min-h-[80px]">
            ...
            <div className="flex items-center relative flex-shrink-0 w-full lg:w-auto mb-4 lg:mb-0">
              ...
              <div className="hexagon-logo absolute w-[80px] h-[92px] bg-[#051b38] top-4 left-4 md:w-[100px] md:h-[115px] md:top-6 md:left-10 lg:w-[120px] lg:h-[138px] lg:top-2 lg:left-20 flex justify-center items-center shadow-xl z-20">
