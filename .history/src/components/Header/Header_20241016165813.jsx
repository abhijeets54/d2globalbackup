      ...
      <header className="bg-customBlue text-customYellow relative">
        <Container>
          <div className="flex justify-between items-center relative py-2" style={{ minHeight: '80px' }}>
            ...
            <div className="flex items-center justify-center flex-shrink-0 w-full md:w-auto relative">
            ...
            {/* Contact Info */}
            <div className="hidden md:flex flex-col items-end space-y-1 mt-2 md:mt-0 md:mr-4">
