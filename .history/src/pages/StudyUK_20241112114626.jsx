...
import FormComponent from '../components/FormComponent'; // Assuming you have a FormComponent like in StudyAustralia
    ...
    <>
      <div className="study-uk-container">
        ...
        <div className="bg-white p-4 md:p-8 lg:p-10 flex flex-col lg:flex-row items-center justify-between space-y-6 lg:space-y-0">
          {/* Left text section */}
          <div className="lg:w-1/2 mt-4"> {/* Adjusted margin to lower text */}
        ...
        <div className="bg-white p-4 md:p-8 lg:p-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-left">Connect with Us</h2>
          <div className="flex flex-col lg:flex-row items-center lg:space-x-8">
            {/* Map Placeholder */}
            <div className="w-full lg:w-1/2 mb-6 lg:mb-0">
              <img src="/uk-map-placeholder.png" alt="Map of UK" className="rounded-lg shadow-lg object-cover" />
            </div>
            {/* Form Component */}
            <div className="w-full lg:w-1/2">
              <FormComponent preferredCountry="UK" />
            </div>
          </div>
        </div>
