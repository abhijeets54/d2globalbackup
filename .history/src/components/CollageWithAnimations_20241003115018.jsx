...
const CollageWithAnimations = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-white flex items-center justify-between px-4 md:px-8">
      ...
      <div className="relative w-1/2 -right-48 flex items-center">
        <motion.img
        ...
        <motion.div
          className="absolute bottom-10 right-7276 p-4 bg-gradient-to-r from-customBlue to-customYellow rounded-lg text-white"
          animate={{ y: [0, -10, 0] }}
