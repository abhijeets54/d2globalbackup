...
function Offer() {
  ...
  return (
    <div className="mx-auto bg-customBlue p-6 md:p-10 shadow">
      ...
      <h2 className="text-center text-3xl sm:text-5xl text-customYellow mt-3 font-extrabold font-sans tracking-wider mb-10 md:mb-16">
        What We Offer
      </h2>
        ...
        <div className="col cursor-pointer transform transition-transform hover:scale-105">
          <Link to="/StudyAbroad">
            <div className="card h-full bg-white rounded-lg shadow overflow-hidden">
              ...
              />
              <div className="p-4">
                <h5 className="text-center text-lg sm:text-xl font-bold font-serif">Study Abroad</h5>
              </div>
            </div>
          </Link>
        </div>
        ...
        <div className="col cursor-pointer transform transition-transform hover:scale-105">
          <Link to="/Training">
            <div className="card h-full bg-white rounded-lg shadow overflow-hidden">
              ...
              />
              <div className="p-4">
                <h5 className="text-center text-lg sm:text-xl font-bold font-serif">Language Coaching</h5>
              </div>
            </div>
          </Link>
        </div>
        ...
        <div className="col cursor-pointer transform transition-transform hover:scale-105">
          <Link to="/TouristVisa">
            <div className="card h-full bg-white rounded-lg shadow overflow-hidden">
              ...
              />
              <div className="p-4">
                <h5 className="text-center text-lg sm:text-xl font-bold font-serif">Tourist Visa</h5>
              </div>
            </div>
          </Link>
        </div>
