    ...
    <div className="w-full min-h-screen flex items-center justify-center bg-white p-4">
      ...
      >
          ...
          <form onSubmit={handleSubmit} ref={form} className="space-y-4">
            ...
            <div className="text-center">
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-cu text-white py-3 px-6 rounded-full font-semibold flex items-center justify-center mx-auto transition duration-300 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                type="submit"
              >
        ...
        <div className="md:w-1/2 w-full hidden md:block relative">
          ...
          />
          <div className="absolute inset-0 bg-customBlue bg-opacity-50 flex items-center justify-center">
