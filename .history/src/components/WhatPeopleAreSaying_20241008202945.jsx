...
const FloatingTestimonials = () => {
  ...
  return (
    <div className="py-12 bg-customBlue flex flex-col h-dynamic justify-center items-center overflow-hidden relative z-0">  {/* Added relative and z-0 */}
      {/* Floating Icons */}
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4">
        <div className="flex justify-center items-center h-[600px] md:h-[700px]">
          {testimonials.map((testimonial, index) => (
            <motion.div
              key={testimonial.id}
              className={`absolute w-95 h-95 md:w-96 md:h-96 bg-white z-50 rounded-full p-8 shadow-lg flex flex-col justify-center items-center text-center ${
