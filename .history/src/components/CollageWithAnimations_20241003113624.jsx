...
const CollageWithAnimations = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-white flex items-center justify-between px-6 md:px-12">
      <div>
      ...
      <div className="relative">
        ...
        <motion.div
          className="absolute -top-12 -left-10 p-4 bg-gradient-to-r from-customBlue to-customYellow rounded-lg text-white"
          animate={{ y: [0, -10, 0] }}
        ...
        {/* Box: Near middle-right of the image */}
        <motion.div
          className="absolute top-20 right-0 p-4 bg-gradient-to-r from-customBlue to-customYellow rounded-lg text-white"
          animate={{ y: [0, -10, 0] }}
