  ...
  return (
    <>
      ...
      <header className="bg-customBlue text-customYellow relative">
        <Container>
          <div className="flex justify-between items-center relative" style={{ height: '100px' }}> 
      ...
      <nav className="shadow bg-customBlue text-customYellow left-0 w-full z-50">
        <Container>
          <div className="py-1 flex justify-center items-center">
            ...
            {/* Mobile Menu */}
            {menuOpen && (
              <div className="md:hidden absolute top-24 left-0 w-full bg-customBlue shadow-md z-40 text-customYellow">
