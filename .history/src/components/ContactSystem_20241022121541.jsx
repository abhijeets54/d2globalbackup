...
const WorldMapContact = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-full max-w-7xl mx-auto flex items-center px-4 justify-items-end">
        {/* Left side text */}
              ...
              {Object.entries(countries).map(([code, { x, y, name }], index) => (
                ...
                >
                  ...
                  <text
                    ...
                    y={y - 16}
                    textAnchor="middle"
                    className="text-xl font-bold fill-gray-800"  // Larger and bolder text
                  >
                    {name}
                  </text>
                </motion.g>
