...
const FloatingCircularTestimonials = () => {
  ...
  return (
    <div className="py-12 bg-customBlue min-h-screen flex flex-col justify-center items-center">
