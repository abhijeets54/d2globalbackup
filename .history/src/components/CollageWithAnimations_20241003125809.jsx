...
const CollageWithAnimations = () => {
  ...
  let charIndex = 0; // Persist charIndex outside the function

  useEffect(() => {
    let typingInterval;

    const startTyping = () => {
      // Ensure we reset the displayed text and charIndex on new text
      setDisplayedText('');
      charIndex = 0;

      typingInterval = setInterval(() => {
        // Check if the current text is still available
