...
import { ChevronLeft, ChevronRight, GraduationCap, Book, Globe, Suitcase, CreditCard, FileText, Compass, 
  PenTool, 
  BookOpen, 
  Globe2,
  Laptop,
...
const PassportServiceSlider = () => {
  ...
  return (
    <div className="relative w-full h-[700px] overflow-hidden">
      ...
      <FloatingIcon Icon={FileText} left={18} top={85} size={24} color="text-customBlue" />
      <FloatingIcon Icon={Flag} left={5} top={75} size={24} color="text-customBlue" />
    <FloatingIcon Icon={MapPin} left={55} top={25} size={26} color="text-customYellow" rotate={-15} />
    <FloatingIcon Icon={Language} left={28} top={70} size={28} color="text-customBlue" rotate={5} />
