  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentIndices(prevIndices => {
        const newIndices = prevIndices.map(index => (index + 1) % testimonials.length);
        return newIndices;
      });
              ...
              >
                ...
                >
                  ...
                  <div className="overflow-y-auto h-64 scrollbar-hide">
                    <p className="text-sm" style={{ fontSize: `${Math.max(12, Math.min(16, 400 / testimonials[index].text.length))}px` }}>
