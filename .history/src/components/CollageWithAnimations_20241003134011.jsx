  ...
  return (
    <div className="relative w-full h-screen flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 bg-gradient-to-r from-gray-50 via-gray-100 to-white">
      ...
      <div className="w-full lg:w-1/2 text-center lg:text-left mt-8 lg:mt-0 relative z-10">
        ...
        <button
          className="px-4 mx-auto py-2 md:px-6 md:py-3 bg-customBlue text-customYellow rounded-3xl text-sm md:text-lg flex items-center justify-center mt-6" // Added mt-6 for spacing
          onClick={() => navigate('/Contactpage')} // Correct use of navigate
        >
          Learn More
