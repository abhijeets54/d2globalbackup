...
const FloatingTestimonials = () => {
  ...
  return (
    <div className="py-12 bg-customBlue flex flex-col h-96 md:h-[700px] lg:h-[800px] justify-center items-center overflow-hidden relative z-0"> {/* Slight increase */}
      {/* Floating Icons */}
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4">
        <div className="flex justify-center items-center h-[600px] md:h-[650px] lg:h-[700px]"> {/* Slight increase */}
