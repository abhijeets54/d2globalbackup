...
const WorldMapContact = () => {
  ...
  // Updated coordinates to match actual geographical positions
  const countries = {
    UK: { x: 480, y: 120, name: 'United Kingdom' },      // Moved to correct position in Western Europe
    Canada: { x: 250, y: 120, name: 'Canada' },          // Adjusted to North America
    Europe: { x: 520, y: 130, name: 'Europe' },          // Centered in Continental Europe
    USA: { x: 220, y: 160, name: 'United States' },      // Centered in North America
    Dubai: { x: 600, y: 200, name: 'Dubai' },            // Moved to UAE region
    Australia: { x: 800, y: 350, name: 'Australia' },    // Adjusted to correct position in Oceania
  };
