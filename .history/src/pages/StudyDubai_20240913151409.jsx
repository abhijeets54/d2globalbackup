...
const StudyDubai = () => {
  return (
    <div className="study-dubai-container">
      ...
      <div className="bg-white p-10 flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="lg:w-1/2">
          <h1 className="text-4xl font-bold flex items-center mb-6">
            <img src="/dubai-flag.svg" alt="Dubai Flag" className="w-8 h-8 mr-2" /> 
            Study in Dubai
          </h1>
          ...
          <div className="flex justify-start space-x-10 text-center">
            <div>
              ...
              <p>QS World Ranking Universities</p>
            </div>
            <div>
              <h3 className="text-3xl font-bold text-red-600">2 years</h3>
              <p>Work Permit After Study</p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:w-1/2 mt-6 lg:mt-0 flex justify-center">
          <img src="/dubai1.webp" alt="Study in Dubai" className="w-full max-w-md rounded-lg shadow-lg" />
        </div>
      </div>

      {/* Why study in Dubai */}
      <div className="bg-blue-950 text-white p-10">
        <h2 className="text-3xl font-bold mb-4">Why Study in Dubai</h2>
        <h3 className="text-2xl font-semibold mb-10">Discover why Dubai is an ideal study destination.</h3>
      ...
      <div className="bg-blue-950 text-white p-10">
        <h2 className="text-3xl font-bold mb-4">Top Universities in Dubai</h2>
