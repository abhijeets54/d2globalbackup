...
const CollageWithAnimations = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-white flex items-center justify-between px-6 md:px-12">
      ...
      {/* Animated Boxes */}
      <motion.div
        className="absolute top-12 left-12 p-4 bg-gradient-to-r from-customBlue to-customYellow rounded-lg text-white"
        animate={{ y: [0, -10, 0] }}
      ...
      <motion.div
        className="absolute bottom-12 right-12 p-4 bg-gradient-to-r from-customBlue to-customYellow rounded-lg text-white"
        animate={{ y: [0, -10, 0] }}
