  ...
  return (
    <>
      ...
      <header className="bg-customBlue text-customYellow relative shadow-md">
        <Container>
          {/* Contact Info Bar */}
          <div className="flex justify-end py-1 text-sm font-openSans">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center relative min-h-[70px]">
            {/* Logo and Company Name */} 
            <div className="flex items-end relative flex-shrink-0 w-full lg:w-auto">
              <button
                onClick={(e) => handleNavigation(e, '/')}
                className="hexagon-logo absolute w-[80px] h-[92px] bg-customBlue -top-2 left-4 md:w-[100px] md:h-[115px] md:-top-4 md:left-10 lg:w-[120px] lg:h-[138px] lg:-top-6 lg:left-20 flex justify-center items-center shadow-xl z-20"
              >
                <img src="/logo.png" alt="D2 Global Logo" className="w-[85%] h-auto object-contain" />
              </button>
              
              <div className="ml-16 md:ml-24 lg:ml-40 xl:ml-48 text-left px-4 pb-2">
                <div className="text-3xl font-bold font-poppins text-customYellow mt-auto">D2 Global</div>
              </div>
            </div>
