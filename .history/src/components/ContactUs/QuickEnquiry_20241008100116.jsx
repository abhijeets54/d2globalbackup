...
const QuickEnquiry = () => {
  ...
  return (
    <div className="fixed left-0 top-1/2 transform -translate-y-1/2 z-50">
      ...
      <div
        className="bg-customBlue hover:bg-blue-800 text-customYellow p-3 sm:p-4 md:p-6 lg:p-12 rounded-r-lg cursor-pointer flex items-center justify-center h-12 w-12 sm:h-16 sm:w-16"
        onClick={toggleForm}
      >
