        ...
        <Container>
          <div className="flex flex-col lg:flex-row justify-between items-center relative min-h-[80px]">
            ...
            <div className="flex items-center relative flex-shrink-0 w-full lg:w-auto mb-4 lg:mb-0">
              ...
              <div className="hexagon-logo absolute w-[100px] h-[115px] bg-[#051b38] top-6 left-4 lg:left-20 flex justify-center items-center shadow-lg z-20">
                <img src="/logo.png" alt="D2 Global Logo" className="w-[85%] h-auto object-contain" />
              </div>
              {/* Company Name */}
              <div className="ml-32 lg:ml-44 pt-2">
                <div className="text-2xl left-6 font-bold text-[#FFD700]">D2 Global</div>
                <div className="text-base left-6 text-white">Education and Immigration</div>
              </div>
            </div>
