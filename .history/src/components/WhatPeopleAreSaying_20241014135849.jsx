...
const FloatingTestimonials = () => {
  ...
  return (
    <div className="relative bg-customBlue text-customYellow py-16 px-4 overflow-hidden">
      {/* Floating Icons */}
      ...
      <div className="flex justify-center items-center h-[450px] space-x-6">
            ...
            >
              ...
              >
                ...
                <div className="overflow-y-auto h-64 scrollbar-hide">
                  <p className="text-base" style={{ fontSize: `${Math.max(16, Math.min(18, 400 / testimonials[index].text.length))}px` }}>
