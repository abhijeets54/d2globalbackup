...
const CollageWithAnimations = () => {
  ...
  return (
    <div className="relative w-full h-screen shadow-xl flex flex-col lg:flex-row items-center justify-center bg-gradient-to-r from-gray-50 via-gray-100 to-white">
      {/* Larger 3D Box Container */}
      <div className="relative w-full lg:w-9/10 xl:w-4/5 bg-white shadow-3xl rounded-xl p-16 lg:p-32 flex flex-col lg:flex-row items-center justify-between transition-all duration-500 hover:shadow-4xl">
        ...
        <div className="relative w-full lg:w-1/2 flex justify-center items-center mt-8 lg:mt-0 z-10">
          <motion.img
            ...
            className="h-80 sm:h-96 md:h-[550px] lg:h-[600px]"
