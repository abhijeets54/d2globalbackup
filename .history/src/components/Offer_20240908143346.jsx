...
function Offer() {
  ...
  const ieltsPteImageUrl = '/ielts.jpeg'; // Update with actual image URL
  const touristVisaImageUrl = '/tourist.jpeg'; // Update with actual image URL

  return (
    <div className="mx-auto bg-blue-900 p-6 md:p-10 shadow">
        ...
        <div className="col cursor-pointer transform transition-transform hover:scale-105">
          <Link to="/IELTSPTE">
            <div className="card h-full bg-white rounded-lg shadow overflow-hidden">
              ...
              />
              <div className="p-4">
                <h5 className="text-center text-lg sm:text-xl font-bold">IELTS / PTE</h5>
              </div>
            </div>
          </Link>
        </div>
