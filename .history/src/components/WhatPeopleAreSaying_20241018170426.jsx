...
const FloatingTestimonials = () => {
  ...
  return (
    <div className="relative bg-customBlue text-customYellow py-16 px-4 overflow-hidden h-[600px]">
      <FloatingIcon Icon={GraduationCap} position="top-4 text-c right-4" />
