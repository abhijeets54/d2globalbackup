      ...
      {slides.map((slide, index) => (
        <div
          ...
          style={{ 
            ...
            filter: 'brightness(90%)',  // Make images a little darker for better text visibility
            boxShadow: '0 8px 16px rgba(0, 0, 0, 0.1)', // Soft shadow for depth
          }}
        >
          <div className="absolute inset-0 flex flex-col items-left justify-center p-8 backdrop-filter backdrop-blur-sm bg-white/60">
