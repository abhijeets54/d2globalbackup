...
const FloatingTestimonials = () => {
  ...
  return (
    <div className="py-12 bg-customBlue flex flex-col h-96 md:h-[550px] lg:h-[550px] justify-center items-center overflow-hidden relative z-0"> {/* Slightly reduced height */}
      {/* Floating Icons */}
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4">
        <div className="flex justify-center items-center h-[550px] md:h-[600px] lg:h-[650px]"> {/* Slightly reduced heights */}
