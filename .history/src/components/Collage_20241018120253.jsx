      ...
      <AnimatePresence initial={false} custom={currentSlide}>
        ...
        >
          <div className="w-full h-full relative overflow-hidden">
            ...
            />
            <div className="absolute inset-0 text bg-black bg-opacity-50 flex items-start justify-start px-6 md:px-12 lg:px-32 py-16 md:py-40">
              <div className="max-w-lg">
                ...
                <motion.button
                  className="px-4 md:px-6 py-2 bg-customBlue text-customYellow rounded-full hover:bg-blue-600 transition-colors duration-300"
