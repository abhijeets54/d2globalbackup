  ...
  return (
    ...
    >
      ...
      <div className="relative h-full max-w-7xl mx-auto flex items-center">
        {/* Empty left space - can be used for content later */}
        <div className="w-1/3" />
        
        {/* Map section moved to right */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="w-2/3 bg-white bg-opacity-90 rounded-xl shadow-lg p-6"
        >
        ...
        {showForm && (
          ...
          >
            ...
            >
              ...
              <div className="w-1/4 p-6 bg-gray-50 flex flex-col justify-between">
