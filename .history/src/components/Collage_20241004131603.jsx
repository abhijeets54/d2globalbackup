    ...
    <div className="relative">
      ...
      <div className="fixed right-4 md:right-10 top-1/2 transform -translate-y-1/2 flex flex-col space-y-4 z-50">
        {[
          ...
          <motion.button
            key={index}
            className="w-14 h-14 flex items-center justify-center rounded-full bg-customBlue/80 hover:bg text-white hover:text-customBlue transition-all duration-300 shadow-md hover:shadow-lg"
