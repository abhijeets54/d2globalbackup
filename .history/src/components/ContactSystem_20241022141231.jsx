    ...
    >
      ...
      <div className="relative h-full max-w-7xl mx-auto flex items-center px-4 justify-items-end flex-col md:flex-row">
        ...
        <div className="md:w-1/3 pr-8">
          <h2 className="text-3xl md:text-5xl font-bold text-white leading-tight text-center md:text-left font-poppins">
            Choose Your Destination
          </h2>
          <p className="text-lg md:text-xl text-gray-200 mt-4 text-center md:text-left font-poppins">
        ...
        >
          <h1 className="text-xl md:text-2xl font-bold text-center mb-8 font-poppins">Select Your Destination</h1>
            ...
            <svg viewBox="0 0 1200 600" className="w-full h-auto" preserveAspectRatio="xMidYMid meet">
              ...
              {Object.entries(countries).map(([code, { x, y, name }], index) => (
                ...
                >
                  ...
                  <rect
                    x={x - 90}  // Increased width
                    y={y - 50}  // Adjusted position
                  ...
                  <text
                    ...
                    y={y - 16}
                    textAnchor="middle"
                    className="text-xl font-bold fill-gray-800 font-poppins"  // Larger and bolder text with custom font
                  >
                    {name}
                  </text>
                </motion.g>
            ...
            >
              ...
              <div className="md:w-3/4 p-6">
                <div className="flex justify-between items-center mb-4">
                  <h2 className="text-xl font-bold font-poppins">Contact Us - {formData.country}</h2>
                  <button
                    onClick={closeForm}
                ...
                <form className="space-y-3" onSubmit={handleSubmit} ref={form}>
                  {responseMessage && (
                    <motion.p
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      className="text-center text-green-600 mb-2 p-2 bg-green-100 rounded-md text-sm font-poppins"
                    >
                      {responseMessage}
                    </motion.p>
                  )}
                  {['name', 'phone', 'email', 'subject'].map((field) => (
                    <div key={field}>
                      ...
                      <input
                        className="w-full px-3 py-2 text-sm text-gray-700 border rounded-lg focus:outline-none focus:border-blue-500 transition duration-300 font-poppins"
                        id={field}
              ...
              {/* Address Section */}
              <div className="md:w-1/4 p-6 bg-gray-50 flex flex-col justify-between rounded-r-xl">
                <h3 className="text-2xl font-bold mb-4 text-gray-800 font-poppins">Visit Us Today!</h3>
