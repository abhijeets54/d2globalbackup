...
const CollageWithAnimations = () => {
  ...
  return (
    <div className="relative w-full h-screen flex flex-col lg:flex-row items-center justify-center bg-gradient-to-r from-gray-50 via-gray-100 to-white">
      ...
      <div className="relative w-full lg:w-5/6 bg-white shadow-2xl rounded-lg p-12 lg:p-20 flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left relative z-10">
          ...
          <button
            className="px-4 py-2 md:px-6 md:py-3 bg-customBlue text-customYellow rounded-3xl text-sm md:text-lg flex items-center justify-center mt-6"
