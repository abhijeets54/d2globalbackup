  ...
  return (
    <div className="relative w-full h-screen bg-white flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20">
      ...
      <div className="relative w-full lg:w-1/2 flex justify-center items-center mt-8 lg:mt-0">
        ...
        {/* Top-left box */}
        <motion.div
          className="absolute top-4 sm:-top-10 sm:-left-10 lg:-top-14 lg:-left-20 p-2 sm:p-4 bg-gradient-to-r from-customBlue to-customYellow rounded-lg text-white text-sm sm:text-base"
          animate={{ y: [0, -10, 0] }}
        ...
        {/* Bottom-left box */}
        <motion.div
          className="absolute bottom-2 sm:bottom-10 left-32 sm:left-48 lg:left-64 p-2 sm:p-4 bg-gradient-to-r from-customBlue to-customYellow rounded-lg text-white text-sm sm:text-base"
          animate={{ y: [0, -10, 0] }}
