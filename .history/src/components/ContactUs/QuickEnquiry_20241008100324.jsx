...
const QuickEnquiry = () => {
  ...
  return (
    <div className="fixed left-0 top-1/2 transform -translate-y-1/2 z-50">
      ...
      <div className="bg-customBlue hover:bg-blue-800 text-customYellow p-5 sm:p-4 md:p-6 lg:p-12 rounded-r-lg cursor-pointer flex items-center justify-center h-16 w-8 sm:h-20 sm:w-10 md:h-24 md:w-12" onClick={toggleForm}>
