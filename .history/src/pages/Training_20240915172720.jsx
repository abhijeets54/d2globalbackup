...
const Training = () => {
  ...
  return (
    <>
      ...
      <motion.div
        className="text-left bg-white px-4 sm:px-6 lg:px-8"
      ...
      >
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <img src="/ielts.webp" alt="Training Banner" className="w-full lg:w-1/3 h-auto" />
        </div>
        <br />
      </motion.div>
      ...
      <motion.div
        className="bg-white shadow-lg rounded-lg p-6 sm:p-8 text-left my-8"
      ...
      <motion.div
        className="bg-white shadow-lg rounded-lg p-6 sm:p-8 text-left "
        initial={{ opacity: 0, x: 100 }}
        animate={{ opacity: loaded ? 1 : 0, x: loaded ? 0 : 100 }}
        transition={{ duration: 1 }}
      >
      ...
      <motion.div
        className="bg-blue-900 text-white p-6 sm:p-8 my-8"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1 }}
      >
      ...
      {/* Call to Action */}
      <motion.div
        className="text-center bg-white p-6 sm:p-8 my-8"
