        ...
        <div className="carousel-inner">
            ...
            <div className="relative h-screen">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
                <div className="text-center text-white px-4 animate-slide-in">
                  <h4 className="text-3xl md:text-5xl font-bold mb-4">Study Visa</h4>
                  <p className="mb-6 text-base md:text-lg">Sample text describing Study Visa.</p>
                  <button
                    className="px-4 py-2 md:px-6 md:py-3 bg-blue-600 text-white rounded-3xl text-sm md:text-lg flex items-center justify-center"
                    onClick={handleDonateClick}
                  >
                    Learn More
                    <FaArrowRight className="ml-4 text-yellow-400" />
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="relative h-screen">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
                <div className="text-center text-white px-4 animate-slide-in">
                  ...
                  <p className="mb-6 text-base md:text-lg">Sample text describing Visitor Visa.</p>
                  <button
                    className="px-4 py-2 md:px-6 md:py-3 bg-blue-600 text-white rounded-3xl text-sm md:text-lg flex items-center justify-center"
                    onClick={handleDonateClick}
                  >
          ...
          <div className="carousel-item">
            <div className="relative h-screen">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
                <div className="text-center text-white px-4 animate-slide-in">
                  <h5 className="text-3xl md:text-5xl font-bold mb-4">IELTS</h5>
                  <p className="mb-6 text-base md:text-lg">Sample text describing IELTS.</p>
                  <button
                    className="px-4 py-2 md:px-6 md:py-3 bg-blue-600 text-white rounded-3xl text-sm md:text-lg flex items-center justify-center"
                    onClick={handleDonateClick}
                  >
          ...
          <div className="carousel-item">
            <div className="relative h-screen">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
                <div className="text-center text-white px-4 animate-slide-in">
                  <h5 className="text-3xl md:text-5xl font-bold mb-4">Work Permit</h5>
                  <p className="mb-6 text-base md:text-lg">Sample text describing Work Permit.</p>
                  <button
                    className="px-4 py-2 md:px-6 md:py-3 bg-blue-600 text-white rounded-3xl text-sm md:text-lg flex items-center justify-center"
                    onClick={handleDonateClick}
                  >
            ...
            <div className="relative h-screen">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
                <div className="text-center text-white px-4 animate-slide-in">
                  ...
                  <p className="mb-6 text-base md:text-lg">Sample text describing Spouse Visa.</p>
                  <button
                    className="px-4 py-2 md:px-6 md:py-3 bg-blue-600 text-white rounded-3xl text-sm md:text-lg flex items-center justify-center"
                    onClick={handleDonateClick}
                  >
