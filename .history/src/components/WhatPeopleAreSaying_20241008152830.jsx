...
const FloatingCircularTestimonials = () => {
  ...
  return (
    <div className="py-12 bg-customBlue min-h-full flex flex-col justify-center items-center">
      ...
      <div className="relative w-full max-w-6xl mx-auto px-4">
        <div className="flex justify-center items-center h-[600px] md:h-[700px]">
          {testimonials.map((testimonial, index) => (
            <motion.div
              key={testimonial.id}
              className={`absolute w-80 h-80 md:w-96 md:h-96 bg-gradient-to-b from-white to-gray-100 rounded-full p-6 shadow-xl flex flex-col justify-center items-center text-center ${
              ...
              animate={{
                ...
                y: [0, -15, 0], // Floating animation up and down
              }}
