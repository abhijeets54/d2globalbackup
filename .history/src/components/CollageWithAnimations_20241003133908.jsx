...
const CollageWithAnimations = () => {
  ...
  return (
    <div className="relative w-full h-screen flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 bg-gradient-to-r from-gray-50 via-gray-100 to-white">
      ...
      {/* Text Section */}
      <div className="w-full lg:w-1/2 text-center lg:text-left mt-8 lg:mt-0 relative z-10 flex flex-col items-start"> {/* Added flex column */}
        ...
        <button
          className="mt-6 px-4 py-2 md:px-6 md:py-3 bg-customBlue text-customYellow rounded-3xl text-sm md:text-lg flex items-center justify-center"
          onClick={() => navigate('/PR')} // Correct use of navigate
        >
          Learn More
