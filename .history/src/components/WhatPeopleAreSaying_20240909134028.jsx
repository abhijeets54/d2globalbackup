...
const WhatPeopleAreSaying = () => {
  ...
  return (
    <div className="py-8 flex flex-col justify-center items-center bg-blue-200">
      <h2 className="text-center text-2xl text-orange-800 sm:text-3xl lg:text-4xl font-bold mb-6">
