    ...
    <div className="relative w-full h-[700px] overflow-hidden">
      {slides.map((slide, index) => (
        ...
        >
          ...
          {/* Text and Button */}
          <motion.div
            className="absolute z-20 w-full text-left px-8"
            style={{ top: '30%', left: '8%' }} // Adjusted position
            initial={{ opacity: 0, y: 50 }} // Start slightly below with opacity 0
            animate={{ opacity: 1, y: 0 }} // Animate to original position
            transition={{ duration: 1, ease: 'easeOut' }} // Smooth animation
          >
            <div className="w-full md:w-1/2 text-white space-y-4"> {/* Spacing between elements */}
              {/* Heading */}
              ...
              <button
                ...
                className="px-6 py-3 bg-customBlue text-white font-semibold rounded-md hover:bg-customYellow transition duration-300"
              >
                {slide.buttonText}
              </button>
            </div>
