...
const QuickEnquiry = () => {
  ...
  return (
    <div className="fixed left-0 top-0 h-full flex items-center z-50">
      ...
      <div
  className="bg-customBlue hover:bg-customYellow text-white px-1 py-20 rounded-r-lg cursor-pointer flex items-center justify-center h-24 w-8 sm:w-6 md:w-8"
  onClick={toggleForm}
>
