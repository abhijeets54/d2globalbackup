...
const QuickEnquiry = () => {
  ...
  return (
    <div className="fixed left-0 top-0 h-full flex items-center z-50">
      ...
      <div
  className="bg-customBlue hover:bg-customYellow text-white px-3 py-5 rounded-r-lg cursor-pointer flex items-center justify-center h-24 w-8 sm:w-10 md:w-12"
  onClick={toggleForm}
>
  <span className="transform -rotate-90 font-bold text-xs sm:text-sm whitespace-nowrap">
    ENQUIRE NOW
  </span>
</div>
