...
>
  <svg viewBox="0 0 100 115" width="100%" height="100%">
    <path
      d="M50 5 L93 30 A10 10 0 0 1 93 85 L50 110 A10 10 0 0 1 7 85 L7 30 A10 10 0 0 1 50 5 Z"
      fill="#051b38"
      stroke="#051b38"
      strokeWidth="1"
    />
    <image href="/logo.png" x="15" y="20" width="70" height="70" preserveAspectRatio="xMidYMid slice" />
  </svg>
</button>
