...
const AnimatedPlaneIntro = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-sky-400 to-sky-200 overflow-hidden">
      ...
      >
        <img
          src="https://assets.vercel.com/image/upload/v1689795055/contentful/image/e5382hct74si/2jtJBvKVTOXJVGZf0Ggx2F/b9e9c9f0e9e9f9f9f9f9f9f9f9f9f9f9/plane.png"
          alt="D2 Global Plane"
      ...
      >
        <h2 className="text-xl font-bold text-sky-600 mb-2">Contact Us</h2>
        <p className="text-sm text-gray-600">
          Email: info@d2global.com<br />
