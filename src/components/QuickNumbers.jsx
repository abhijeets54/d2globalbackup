...
function QuickNumbers() {
  ...
  return (
    <div ref={quickNumbersRef} className="bg-blue-950 py-8 w-full">
      <h2 className="text-center text-2xl sm:text-4xl font-bold text-yellow-400 pt-5 mb-8">
        QUICK NUMBERS
      </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-24 mt-5 pb-5">
        {data.map((item, index) => (
          <div key={index} className="text-center text-yellow-400 flex flex-col items-center">
