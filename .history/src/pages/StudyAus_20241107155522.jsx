...
const StudyAus = () => {
  const handleMapClick = () => {
    // Code to open QuickEnquiry form with pre-selected "Australia" as the country
    QuickEnquiry({ selectedCountry: "Australia" });
  };
      ...
      <div className="study-aus-container pt-16"> {/* Added padding-top to push content down */}
        ...
        >
          <div className="flex flex-col lg:flex-row items-center justify-between">
            ...
            >
              <img src="/maps/ausmap.png" alt="Map of Australia" className="w-full max-w-md lg:max-w-lg rounded-lg shadow-lg object-cover" />
            </div>
          </div>
        </div>
      </div>
