...
function Choose() {
  ...
  const slideInUp = {
    ...
    visible: (i) => ({
      ...
      y: 0,
      transition: {
        delay: i * 0.3, // Delay each feature animation
      },
    }),
  };
  ...
  return (
    <section className="py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-red-600 font-poppins">
            Why Choose Us?
          </h2>
          <p className="mt-4 text-lg md:text-xl text-gray-600 font-mukta">
            We are committed to providing you with the best of immigration services to help you achieve your dreams of studying and settling abroad.
          </p>
        </motion.div>
        ...
        <div className="grid gap-10 md:grid-cols-3">
          ...
          >
            ...
            <h4 className="text-xl font-semibold text-gray-800 mb-4 font-mukta"> {/* Use custom font here */}
              Expert Admission Guidance
            </h4>
            <p className="text-gray-600 font-bold font-mukta">
          ...
          >
            ...
            <h4 className="text-xl font-semibold text-gray-800 mb-4 font-mukta">
        ...
        >
          {/* Uncomment the button to use it */}
          {/* <a
            href="/contact"
