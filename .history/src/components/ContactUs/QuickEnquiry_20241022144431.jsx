...
const QuickEnquiry = () => {
  ...
  return (
    <div className="fixed right-0 top-0 h-full flex items-center z-50">
      ...
      <div
        className="bg-customBlue hover:bg-customYellow text-white px-2 py-4 rounded-l-lg cursor-pointer flex items-center justify-center h-16 w-6 sm:w-8 md:w-10"
        onClick={toggleForm}
      >
        <span className="transform -rotate-90 font-bold text-xs whitespace-nowrap">ENQUIRE</span>
      </div>

      {/* Contact Form */}
      <div
        className={`fixed right-0 top-0 h-full w-full sm:w-80 md:w-96 lg:w-96 bg-white shadow-lg transition-transform duration-500 flex flex-col ${
