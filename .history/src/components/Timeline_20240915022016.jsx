      ...
      <div className="relative w-full max-w-5xl px-4">
        ...
        {timelineData.map((item, index) => (
          <div
            ...
            className="relative flex flex-col items-center mb-60 w-full max-w-xs sm:max-w-md md:max-w-lg mx-auto"
          >
            {/* Dot */}
            <div
            ...
            <div
              className={`absolute p-4 bg-white border border-yellow-500 rounded-lg shadow-lg w-64 md:w-72 lg:w-80 transform transition-transform duration-500 ${
                activeIndex === index ? 'fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2' : ''
              }`}
              style={{
                position: activeIndex === index ? 'fixed' : 'absolute',
              }}
            >
