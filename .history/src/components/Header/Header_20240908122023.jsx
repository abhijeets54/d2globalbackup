      ...
      <div className="bg-blue-950 py-2 text-white text-sm">
        <Container>
          <div className="flex flex-col lg:flex-row justify-between items-center px-16 lg:px-16">
            <div className="flex items-center mb-2 lg:mb-1 space-x-4">
              <span>
            ...
            <div className="flex space-x-4 items-center text-lg">
              <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 text-xl">
                <FaFacebookF />
              </a>
