          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center flex-shrink-0">
              <button onClick={() => navigate('/')} className="focus:outline-none">
                <Logo className="w-16 h-16 object-contain" /> {/* Smaller logo */}
              </button>
              <div className="ml-2 text-customYellow text-left"> {/* Smaller margin and text */}
                <p className="text-xl font-semibold">D2 Global</p> {/* Smaller text */}
                <p className="text-md">Education and Immigration</p> {/* Smaller text */}
              </div>
            </div>
