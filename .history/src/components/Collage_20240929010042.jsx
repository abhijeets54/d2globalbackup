            ...
            <div className="relative h-screen bg-gradient-to-r from-customBlue to-customYellow">
              <div className="absolute inset-0 flex flex-col justify-center items-center">
                ...
                <div className="text-center text-white px-4 z-20">
                  <h4 className="text-3xl  text-customBlue md:text-5xl font-serif font-bold mb-2">Where Your Global Dreams Take Flight</h4>
                  <p className="mb-4 font-semibold text-customBlue text-2xl">Unlock endless opportunities with global education.</p>
