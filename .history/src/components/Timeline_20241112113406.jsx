...
const timelineData = [
  { 
    ...
    description: 'Became certified in IELTS, marking the beginning of our expertise in language proficiency and test preparation services.' 
  },
  { 
    year: '2016', 
    event: 'Immigration in Canada', 
  ...
  { 
    year: '2018', 
    event: 'Immigration Australia & New Zealand', 
  ...
  { 
    year: '2022', 
    event: 'Immigration Europe (Schengen)', 
  ...
  { 
    year: '2023', 
    event: 'India Canadian Business Chamber (ICBC) Membership', 
    description: 'Joined the India Canadian Business Chamber (ICBC), strengthening our network and resources to better serve clients moving to Canada.' 
  },
  { 
    year: '2024', 
