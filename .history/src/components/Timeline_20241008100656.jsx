...
const timelineData = [
  ...
  { year: '2016', event: 'International Partnerships', description: 'Established partnerships with top educational institutions in the UK, Canada, and Europe for enhancing opportunities for students.' },
