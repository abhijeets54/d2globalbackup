...
const WorldMapContact = () => {
  ...
  className="w-full md:w-3/4 max-w-[1100px] bg-white bg-opacity-95 rounded-xl shadow-lg p-6 mt-6 md:mt-0 md:ml-28 ml-4" // Increased left margin for desktop and mobile
>
