...
const CollageWithAnimations = () => {
  ...
  return (
    <div className="relative w-full  h-[500px] flex items-center justify-center bg-gradient-to-br from-customYellow/50 via-customYellow/30 to-white p-4 md:p-8">
      ...
      <div className="w-full max-w-8xl bg-customBlue shadow-2xl h-[400px] rounded-lg p-12 md:p-24 flex flex-col lg:flex-row items-center justify-between transition-all duration-500 hover:shadow-3xl relative overflow-hidden">
        {/* Text Section */}
