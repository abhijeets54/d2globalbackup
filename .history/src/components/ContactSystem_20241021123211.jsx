...
const WorldMapContact = () => {
  ...
  const countries = {
    UK: { x: 570, y: 130, name: 'United Kingdom' }, // Adjusted x-coordinate for UK
    Canada: { x: 220, y: 100, name: 'Canada' },
    Europe: { x: 620, y: 140, name: 'Europe' }, // Adjusted x-coordinate for Europe
    USA: { x: 300, y: 170, name: 'United States' },
              ...
              {Object.entries(countries).map(([code, { x, y, name }], index) => (
                ...
                >
                  ...
                  <rect
                    ...
                    height="20"
                    fill="white"
                    opacity="1" // Solid white background
                    rx="5" // Rounded corners
                    className="drop-shadow-lg" // Added shadow
                  />
                  <text
                    x={x}
                    y={y - 10}
            ...
            >
              ...
              >
                ...
                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                  {/* Full form, with additional fields */}
                  <div>
