...
const CollageWithAnimations = () => {
  ...
  return (
    <div className="relative w-full h-[450px] flex items-center justify-center bg-gradient-to-br from-customYellow/50 via-customYellow/30 to-white p-4 md:p-8">
      ...
      <div className="w-full max-w-7xl bg-customBlue shadow-2xl h-[350px] rounded-lg p-8 md:p-16 flex flex-col lg:flex-row items-center justify-between transition-all duration-500 hover:shadow-3xl relative overflow-hidden">
        {/* Text Section */}
        ...
        <div className="relative w-full lg:w-1/2 flex justify-center items-center">
          ...
          {/* Floating boxes */}
          <motion.div
            className="absolute -top-3 -left-3 py-2 px-4 bg-customYellow text-customBlue rounded-lg text-sm md:text-base shadow-lg"
            animate={{ y: [0, -10, 0] }}
