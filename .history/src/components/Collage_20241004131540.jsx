...
import CollageWithAnimations from './CollageWithAnimations'; // Import the animation component
        ...
        <div className="carousel-inner">
            ...
            <div className="relative h-screen">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
                <div className="text-center text-white px-4 animate-slide-in">
                  ...
                  <button
                    className="px-4 py-2 md:px-6 md:py-3 bg-customBlue text-customYellow rounded-3xl text-sm md:text-lg flex items-center justify-center"
          ...
          <div className="carousel-item">
            <div className="relative h-screen">
              ...
              />
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
                <div className="text-center text-white px-4 text-left animate-slide-in">
          ...
          <div className="carousel-item">
            <div className="relative h-screen">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
                <div className="text-center text-white px-4 animate-slide-in">
                  <h5 className="text-3xl md:text-5xl font-bold mb-4">Permanent Residency</h5>
                  <p className="mb-6 text-base text-left md:text-lg">Settle in the right country</p>
                  <button
                    className="px-4 py-2 md:px-6 md:py-3 bg-customBlue text-customYellow rounded-3xl text-sm md:text-lg flex items-center justify-center"
                    onClick={() => navigate('/PR')}
                  >
