    ...
    <>
      <div className="study-can-container bg-white pt-16">
              ...
              >
                ...
                <form ref={form} onSubmit={handleSubmit}>
                  ...
                  <button type="submit" className="bg-red-600 text-white py-2 px-4 rounded-lg w-full">
                    Send Message <FaPaperPlane className="inline-block ml-1" />
                  </button>
                </form>
        ...
        <div className="bg-blue-950 text-white p-6 lg:p-10 text-left">
          <h2 className="text-2xl lg:text-3xl font-bold mb-4">Find Us</h2>
          <p className="mb-4">Visit our office and meet our experts for more guidance.</p>
          <button
            onClick={handleMapClick}
            className="bg-yellow-500 text-black px-4 py-2 rounded-lg font-semibold flex items-center"
          >
            <FaMapMarkerAlt className="mr-2" /> Open Contact Form
          </button>
        </div>
