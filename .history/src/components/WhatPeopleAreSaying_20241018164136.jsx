...
const TestimonialCircle = ({ testimonial, index, currentIndex }) => {
  ...
  return (
    ...
    >
      <div className={`bg-white text-customBlue p-4 rounded-full w-58 h-48 border-3 border-customBlue flex flex-col justify-center items-center text-center shadow-xl ${isCenter ? 'z-10' : 'z-0'}`}>
