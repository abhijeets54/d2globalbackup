  ...
  <div className="relative h-screen bg-gradient-to-r from-customBlue to-customYellow">
    <div className="absolute inset-0 flex flex-col justify-center items-center">
      ...
      <div className="text-center text-white px-4 z-20">
        ...
        {/* Contact Us Button */}
        <button
          className="mt-6 px-4 mx-py-2 md:px-6 md:py-3 bg-customBlue text-white rounded-3xl text-sm md:text-lg flex items-center justify-center hover:shadow-lg transition-transform transform hover:scale-105"
