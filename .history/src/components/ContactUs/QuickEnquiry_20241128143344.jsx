...
const QuickEnquiry = () => {
  ...
  return (
    <div className="fixed left-0 top-0 h-full flex items-center z-50">
      ...
      <div
  className="bg-customBlue hover:bg-customYellow text-white px-0.5 py-20 rounded-r-lg cursor-pointer flex items-center justify-center h-24 w-6 sm:w-5 md:w-6"
  onClick={toggleForm}
>
