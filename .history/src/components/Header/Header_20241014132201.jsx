...
function Header() {
  ...
  return (
    <>
      ...
      <header className="bg-customBlue text-customYellow py-1">
        <Container>
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center flex-shrink-0 ml-8">
              ...
              <div className="ml-2 text-customYellow text-left">
                ...
                <p className="text-lg">Education and Immigration</p>
              </div>
            </div>
      ...
      {/* Navigation Header */}
      <nav className="shadow bg-customBlue text-customYellow left-0 w-full z-50 mr-20">
        <Container>
