...
const TestimonialCircle = ({ testimonial, index, currentIndex, totalItems }) => {
  ...
  return (
    ...
    >
      <div className={`bg-white text-customBlue p-8 rounded-full w-64 h-64 border-3 border-custom flex flex-col justify-center items-center text-center shadow-xl ${isCenter ? 'z-10' : 'z-0'}`}>
