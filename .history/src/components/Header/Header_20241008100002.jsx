...
{/* <div className="bg-customBlue py-2 text-customYellow text-sm">
  <div className="container mx-auto flex justify-center">
    <div className="flex space-x-6 items-center text-xl lg:text-2xl">
      <a
              ...
              {navItems.map((item, index) => (
                <li key={item.name} className="relative">
                  <button
                    ...
                    className={`underline-slide inline-block px-6 py-3 lg:py-3 text-lg lg:text-xl duration-200 ${location.pathname === item.slug ? 'active-page' : 'text-customYellow'}`}
                  >
                    {item.name}
                  </button>
