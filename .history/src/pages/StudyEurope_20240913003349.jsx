  ...
  return (
    <div className="study-europe-container">
      ...
      <div className="bg-white p-10 flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="lg:w-1/2">
          <h1 className="text-4xl font-bold flex items-center mb-6">
            <img src="/europeflag.svg" alt="Europe Flag" className="w-8 h-8 mr-2" /> 
            Study in Europe
          </h1>
        ...
        <div className="lg:w-1/2 mt-6 lg:mt-0 flex justify-center">
          <img src="/europe1.webp" alt="Study in Europe" className="w-full max-w-md rounded-lg shadow-lg" />
        </div>
      </div>

      {/* Why study in Europe */}
      <div className="bg-blue-950 text-white p-10">
        <h2 className="text-3xl font-bold mb-4">Why Study in Europe</h2>
        <h3 className="text-2xl font-semibold mb-10">Explore the best opportunities and education system Europe has to offer.</h3>
      ...
      <div className="bg-white p-10 text-left">
        <h2 className="text-3xl font-bold mb-6">Requirements for Europe Study Visa</h2>
      ...
      <div className="bg-gray-200 p-10">
        <h2 className="text-3xl font-bold mb-6">Top Universities in Europe</h2>
        <ul className="list-disc list-inside space-y-2 text-lg">
