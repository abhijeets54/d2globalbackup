      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-lg">
        ...
        <div className="flex items-center md:items-start space-x-4">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-white text-lg font-merriweather">Education and Immigration</p>
          </div>
        </div>
        ...
        <div className="space-y-4 text-center md:text-left">
          ...
          <a href="/AboutUs" className="text-gray-400 hover:text-customYellow font-openSans">About</a> <br />
          <a href="/StudyAbroad" className="text-gray-400 hover:text-customYellow font-openSans">Study Abroad</a> <br />
          <a href="/TouristVisa" className="text-gray-400 hover:text-customYellow font-openSans">Tourist Visa</a> <br />
          <a href="/ContactUs" className="text-gray-400 hover:text-customYellow font-openSans">Contact Us</a> <br />
          <a href="/PR" className="text-gray-400 hover:text-customYellow font-openSans">Permanent Residency</a> <br />
          <a href="/Training" className="text-gray-400 hover:text-customYellow font-openSans">Training</a>
        </div>
