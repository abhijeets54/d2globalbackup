...
const WhatPeopleAreSaying = () => {
  ...
  return (
    <div className="py-8 flex flex-col justify-center items-center bg-blue-100">
      <h2 className="text-center text-2xl text-orange-600 sm:text-3xl lg:text-4xl font-bold mb-6">
      ...
      <div className="relative w-full max-w-5xl mx-auto p-6 bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        >
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className="w-full flex-shrink-0 flex flex-col md:flex-row justify-between items-center p-4"
            >
              ...
              <div className="w-full md:w-1/2 p-4">
                ...
                <p className="text-gray-700 text-base md:text-lg">{testimonial.text}</p>
              </div>
            </div>
          ))}
        </div>
