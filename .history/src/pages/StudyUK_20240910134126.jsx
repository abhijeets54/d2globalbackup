  ...
  return (
    ...
    <div className="study-uk-container">
      ...
      <div className="bg-white  p-10">
        <h2 className="text-3xl text-left font-bold mb-4">Why Study in UK</h2>
        <h3 className="text-2xl text-left font-semibold mb-10">Experience an unforgettable academic adventure within a dynamic culture.</h3>
        ...
        >
          {points.map((point, index) => (
            ...
            >
              <h4 className="text-lg text-white font-semibold mb-2">{point.title}</h4>
