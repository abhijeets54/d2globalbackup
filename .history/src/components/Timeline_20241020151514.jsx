...
const timelineData = [
  ...
  { year: '2016', event: 'International Partnerships', description: 'Established partnerships with top educational institutions in UK, Canada, and Europe for enhancing opportunities for students.' },
  ...
  { year: '2023', event: '450+ Study Visas Processed', description: 'Achieved a significant milestone by successfully processing over 450 study visas for students in UK and Canada.' },
...
const HorizontalTimeline = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center py-10 bg-customBlue">
      ...
      {/* Heading */}
      <h2 className="text-4xl font-bold text-customYellow mb-10">Journey of D2 Global</h2>
