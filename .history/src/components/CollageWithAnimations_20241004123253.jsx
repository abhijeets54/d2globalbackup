...
const CollageWithAnimations = () => {
  ...
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center bg-gradient-to-r from-customYellow/30 via-customYellow/20 to-white p-4 md:p-8">
      ...
      <div className="w-full max-w-7xl bg-customBlue shadow-2xl rounded-lg p-10 md:p-20 flex flex-col lg:flex-row items-center justify-between transition-all duration-500 hover:shadow-3xl relative overflow-hidden">
        {/* Text Section */}
        <div className="w-full lg:w-1/2 text-center lg:text-left relative z-10 mb-8 lg:mb-0">
          ...
          <button
            className="px-6 py-3 bg-customYellow text-customBlue rounded-full text-lg flex items-center justify-center mx-auto lg:mx-0 hover:bg-white hover:text-customBlue transition-colors duration-300"
