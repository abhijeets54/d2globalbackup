...
const FloatingCircularTestimonials = () => {
  ...
  return (
    <div className="py-6 bg-customBlue min-h-fit flex flex-col justify-center items-center">
      <h2 className="text-center text-3xl md:text-4xl lg:text-5xl font-bold text-customYellow mb-8">
