...
const CollageWithAnimations = () => {
  ...
  return (
    <div className="relative w-full  h-[300px] flex items-center mt-20justify-center bg-gradient-to-br from-customYellow/50 via-customYellow/30 to-white p-4 md:p-8">
