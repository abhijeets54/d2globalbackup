          ...
          <form onSubmit={handleSubmit} ref={form} className="space-y-4">
            ...
            <div className="text-center">
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="bg text-white py-3 px-6 rounded-full font-semibold flex items-center justify-center mx-auto transition duration-300 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                type="submit"
              >
