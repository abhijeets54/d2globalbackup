...
const StudyAus = () => {
  return (
    <>
      <div className="study-aus-container pt-16"> {/* Added padding-top to push content down */}
        {/* Top section */}
        ...
        <div className="bg-cover bg-center p-8 md:p-12 lg:p-16 text-white" style={{ backgroundImage: "url('/path/to/background-image.jpg')" }}>
          <div className="flex flex-col lg:flex-row items-center justify-between">
            ...
            <div className="lg:w-1/2 flex justify-center">
              <img src="/path/to/map-image.jpg" alt="Map of Australia" className="w-full max-w-xs md:max-w-md lg:max-w-lg rounded-lg shadow-lg object-cover" />
            </div>
          </div>
        </div>
      </div>
