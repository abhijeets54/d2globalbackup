      ...
      <div className="study-aus-container bg-white pt-16">
        ...
        >
          ...
          <div className="relative flex flex-col lg:flex-row items-center justify-between max-w-6xl mx-auto">
            <div className="lg:w-1/2 mb-4 lg:mb-0 text-left">
              <h2 className="text-2xl md:text-3xl font-bold mb-2">Choose Your Destination</h2>
                  ...
                  <div className="space-y-4">
                    <div className="text-white">
                      <div className="flex items-start mb-2">
                        <FaMapMarkerAlt className="text-lg mt-1 mr-1" />
                        <div>
                    ...
                    <div className="text-white">
                      <div className="flex items-start mb-2">
                        <FaMapMarkerAlt className="text-lg mt-1 mr-1" />
                        <div>
                          <p className="font-semibold mb-1">Sub Branch</p>
                          <p className="text-sm text-left leading-relaxed">
                            Rattan Bazar Adda,
