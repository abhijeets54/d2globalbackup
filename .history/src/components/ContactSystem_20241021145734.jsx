...
const WorldMapContact = () => {
  ...
  const countries = {
    UK: { x: 540, y: 130, name: 'United Kingdom' }, // Adjusted x-coordinate for visibility
    Canada: { x: 220, y: 100, name: 'Canada' },
    Europe: { x: 630, y: 150, name: 'Europe' }, // Adjusted x-coordinate for Europe
          ...
          <div className="relative">
            ...
            <svg viewBox="0 0 1200 600" className="w-full h-auto">
              ...
              {Object.entries(countries).map(([code, { x, y, name }], index) => (
                ...
                >
                  <image href="/register/pin.svg" x={x - 18} y={y - 36} width="36" height="36" />
                  <rect
                    x={x - 60}
                    y={y - 42}
                    width="120"
