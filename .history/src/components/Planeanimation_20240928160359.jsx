...
const PlaneAnimation = () => {
  useEffect(() => {
    ...
    gsap.fromTo(
      plane,
      { x: '-100%', scale: 0.5 }, // Start from off-screen to the left
      {
        x: '50%', // Move to the center of the screen
        ...
        onComplete: () => {
          ...
          gsap.to(plane, {
            x: '100%', // Move out to the right of the screen
  ...
  return (
    <div className="relative h-screen bg-gradient-to-r from-customBlue to-customYellow overflow-hidden">
      ...
      {/* Animated Plane */}
      <div className="plane absolute w-80 h-auto top-1/3 left-0 transform -translate-x-1/2"> {/* Translate the plane by half its width */}
