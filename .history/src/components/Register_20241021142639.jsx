            ...
            <form onSubmit={handleSubmit} ref={form} className="space-y-4">
              {['name', 'phone', 'email', 'country', 'subject'].map((field) => (
                <div key={field}>
                  ...
                  {field === 'country' ? (
                    <select
                      className="w-full px-4 py-3 text-base text-gray-700 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 transition duration-300"
                      id={field}
                      name={field}
              ...
              <div className="text-center">
                <motion.button 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-customBlue text-white py-3 px-8 rounded-full text-sm font-semibold flex items-center justify-center mx-auto transition duration-300 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                  type="submit"
                >
