...
const timelineData = [
  ...
  { 
    year: '2016', 
    event: 'Start of Immigration Services', 
    description: 'Started providing specialized immigration services for Canada, helping students and professionals explore opportunities in the country.' 
  },
  { 
    year: '2017', 
  ...
  { 
    year: '2018', 
    event: 'Expansion of immigration services to Australia and New Zealand.', 
  ...
  { 
    year: '2019', 
    event: 'Heading Immigration consultancy for the UK ', 
  ...
  { 
    year: '2024', 
    event: 'Gained British Council Certification ', 
    description: 'Further reinforced our credentials by becoming a British Council Certified Agent, recognized.' 
  },
