...
import { FaInstagram, FaFacebookF, FaYoutube, FaArrowRight, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
  ...
  return (
    <div className="relative">
      <div
        ...
        data-bs-wrap="true"  {/* Enables continuous looping */}
      >
        {/* Indicators */}
        ...
        <button
          className="carousel-control-prev absolute top-1/2 left-0 transform -translate-y-1/2 text-white p-4 bg-black bg-opacity-50 rounded-full hover:bg-opacity-80 transition-all duration-300"
          type="button"
          data-bs-target="#carouselExampleCaptions"
          data-bs-slide="prev"
        >
        ...
        <button
          className="carousel-control-next absolute top-1/2 right-0 transform -translate-y-1/2 text-white p-4 bg-black bg-opacity-50 rounded-full hover:bg-opacity-80 transition-all duration-300"
          type="button"
          data-bs-target="#carouselExampleCaptions"
          data-bs-slide="next"
        >
