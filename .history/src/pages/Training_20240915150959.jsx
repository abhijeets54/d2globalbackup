...
const Training = () => {
  ...
  return (
    ...
    <QuickEnquiry/>
      ...
      >
        <h1 className="text-3xl sm:text-4xl bg-white font-bold text-indigo-600 mb-4">IELTS, PTE & Spoken English Training</h1>
        <p className="text-lg bg-white text-gray-600">
