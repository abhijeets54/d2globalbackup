...
const Collage = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      link: '/language-coaching' // Link for the language coaching page
    },
  ];
      ...
      <AnimatePresence initial={false} custom={currentSlide}>
        ...
        >
          <div className="w-full h-full relative overflow-hidden">
            ...
            />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-start justify-start px-64 py-40">
