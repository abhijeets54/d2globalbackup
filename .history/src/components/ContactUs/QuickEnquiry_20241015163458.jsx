          ...
          <form onSubmit={handleSubmit} ref={form} className="space-y-2 sm:space-y-3 flex-grow flex flex-col justify-between">
            <div className="space-y-2 sm:space-y-3">
              ...
              <div>
                ...
                <input
                  className="shadow appearance-none border rounded w-full py-2 sm:py-2 px-2 sm:px-3 text-gray-700 text-xs sm:text-sm leading-tight focus:outline-none focus:shadow-outline"
                  id="phone"
                  type="text"
                  name="phone"
                  value={phone}
