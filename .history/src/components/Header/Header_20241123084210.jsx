      ...
      <header className="bg-customBlue text-customYellow relative shadow-md">
        <Container>
          <div className="flex flex-col lg:flex-row justify-between items-center relative min-h-[80px]">
            {/* Contact Info */}
            <div className="absolute top-4 left-4 md:left-10 lg:left-20 flex flex-col items-start space-y-1 text-sm font-openSans">
              <a href="mailto:info@d2global.in" className="flex items-center text-customYellow">
                <FaEnvelope className="mr-1" />
                info@d2global.in
              </a>
              <a href="tel:+919878990455" className="flex items-center text-customYellow">
            ...
            <div className="flex items-center relative flex-shrink-0 w-full lg:w-auto mb-4 lg:mb-0">
              ...
              <div className="ml-16 md:ml-24 lg:ml-40 xl:ml-48 text-left px-4 -mb-2 pb-2">
                                ...
                                {subItem.subDropdown.map((subSubItem) => (
                                  <li key={subSubItem.name}>
                                    <a
                                      ...
                                      className={`block px-4 py-2 w-full text-left text-sm hover:bg-blue-700 transition-colors duration-150 ${
                            ...
                            {subItem.subDropdown.map((subSubItem) => (
                              <li key={subSubItem.name}>
                                <a
                                  href={subSubItem.slug}
                                  onClick={(e) => handleNavigation(e, subSubItem.slug)}
                                  className={`block px-8 py-2 w-full text-left text-sm hover:bg-customBlue ${
                                    location.pathname === subSubItem.slug ? 'font-bold' : ''
                                  }`}
                                >
                                  {subSubItem.name}
