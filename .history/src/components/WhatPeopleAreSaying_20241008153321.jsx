...
const FloatingCircularTestimonials = () => {
  ...
  return (
    <div className="py-2 bg-customBlue min-h-fit flex flex-col justify-center items-center">
      ...
      <div className="relative w-full max-w-6xl mx-auto px-4">
        <div className="flex justify-center items-center h-[500px] md:h-[600px]">
          {testimonials.map((testimonial, index) => (
            <motion.div
              key={testimonial.id}
              className={`absolute w-64 h-64 md:w-80 md:h-80 bg-white rounded-full px-6 shadow-lg flex flex-col justify-center items-center text-center ${
