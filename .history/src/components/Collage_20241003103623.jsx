          ...
          <div className="carousel-item active">
            <div className="relative h-screen">
              <img
                ...
                alt="Study Visa"
              />
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-start pl-4 md:pl-10">
                <div className="text-white animate-fade-in-left">
                  ...
                  <p className="text-base md:text-lg">D2 Global Immigration helps you achieve your dreams of studying, working, and settling abroad. We provide comprehensive immigration services with expert guidance.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative h-screen">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-start pl-4 md:pl-10">
                <div className="text-white animate-fade-in-left">
                  ...
                  <p className="mb-6 text-base md:text-lg">Settle in the right country.</p>
                  <button
                    className="px-4 py-2 md:px-6 md:py-3 bg-blue-950 text-white rounded-3xl text-sm md:text-lg flex items-center justify-center"
                    onClick={() => navigate('/PR')}
                  >
