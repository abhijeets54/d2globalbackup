...
const QuickEnquiry = () => {
  ...
  return (
    <div className="fixed left-0 top-1/2 transform -translate-y-1/2 z-50">
      ...
      <div
        className="bg-customBlue hover:bg-customYellow text-white px-2 py-8 rounded-r-full cursor-pointer flex items-center justify-center h-40 w-10"
        onClick={toggleForm}
      >
        <span className="transform -rotate-90 font-bold text-sm">ENQUIRE NOW</span>
      </div>
