    ...
    <section className="py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 text-center">
            <div className="flex justify-center mb-6">
              <img src="/scholarship.webp" alt="Scholarship Guidance" className="h-16 w-16" />
            </div>
            <h4 className="text-xl font-semibold text-gray-800 mb-4">Scholarship Guidance</h4>
            <p className="text-gray-600">
              We help you explore and apply for scholarships, fee waivers, and bursaries that could ease your financial burden while studying abroad.
            </p>
          </div>
