  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* Arrow buttons */}
        <button
          className="carousel-control-prev absolute top-1/2 left-0 transform -translate-y-1/2 text-white text-4xl p-3"
          type="button"
          data-bs-target="#carouselExampleCaptions"
          data-bs-slide="prev"
        >
        ...
        <button
          className="carousel-control-next absolute top-1/2 right-0 transform -translate-y-1/2 text-white text-4xl p-3"
          type="button"
          data-bs-target="#carouselExampleCaptions"
          data-bs-slide="next"
        >
