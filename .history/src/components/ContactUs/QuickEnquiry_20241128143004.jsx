...
const QuickEnquiry = () => {
  ...
  return (
    <div className="fixed left-0 top-0 h-full flex items-center z-50">
      ...
      <div
        className="bg-customBlue hover:bg-customYellow text-white px-12 py-10 rounded-r-lg cursor-pointer flex items-center justify-center h-24 w-10 sm:w-8 md:w-10"
        onClick={toggleForm}
      >
