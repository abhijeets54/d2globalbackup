...
const CollageWithAnimations = () => {
  ...
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center bg-gradient-to-r from-gray-50 via-gray-100 to-white p-4 md:p-8">
      ...
      <div className="w-full max-w-7xl bg-white shadow-2xl rounded-lg p-10 md:p-20 flex flex-col lg:flex-row items-center justify-between transition-all duration-500 hover:shadow-3xl relative overflow-hidden">
        {/* Text Section */}
        <div className="w-full lg:w-1/2 text-center lg:text-left relative z-10 mb-8 lg:mb-0">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-4">
            D2 Global
          </h1>
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-600 mb-6">
