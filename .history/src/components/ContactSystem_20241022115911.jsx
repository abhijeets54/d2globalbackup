...
const WorldMapContact = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-3/4 max-w-7xl mx-auto flex items-center px-4"> {/* Reduced height */}
        {/* Left side text */}
        <div className="w-1/3 pr-8">
          <h2 className="text-4xl font-bold text-white leading-tight"> {/* Reduced font size */}
            Choose Your Destination
          </h2>
          <p className="text-lg text-gray-200 mt-4"> {/* Reduced font size */}
        ...
        >
          <h1 className="text-3xl font-bold text-center mb-6"> {/* Increased font size */}
              ...
              {Object.entries(countries).map(([code, { x, y, name }], index) => (
                ...
                >
                  ...
                  <text
                    ...
                    y={y - 16}
                    textAnchor="middle"
                    className="text-xl font-semibold fill-gray-800"  // Increased text size
                  >
                    {name}
                  </text>
                </motion.g>
