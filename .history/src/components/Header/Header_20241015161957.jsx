...
function Header() {
  ...
  <butt<div className="flex items-center flex-grow ml-8"> {/* Updated flex-grow to extend */}
  <button onClick={() => navigate('/')} className="focus:outline-none">
    <Logo className="w-28 h-28 object-contain" /> {/* Increased size */}
  </button>
  <div className="ml-4 text-customYellow text-left flex flex-col justify-center"> {/* Adjusted ml and added flex styles */}
    <p className="text-3xl lg:text-5xl font-semibold">D2 Global</p> {/* Increased font size */}
    <p className="text-xl lg:text-2xl">Education and Immigration</p> {/* Increased font size */}
  </div>
</div>
