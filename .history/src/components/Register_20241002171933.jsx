  ...
  return (
    <section className="bg-white">
      <div className="flex flex-col lg:flex-row lg:min-h-screen lg:items-center">
        {/* Combined Box for Image and Form */}
        <div className="flex flex-col lg:flex-row w-full border border-gray-300 rounded-lg shadow-lg overflow-hidden">
          {/* Image Section */}
          ...
          {/* Form Section */}
          <main className="flex items-center justify-center lg:w-1/2 p-6">
