...
const customStyles = `
  .hexagon-logo {
    clip-path: polygon(
      50% 0%, 85% 20%, 85% 80%, 50% 100%, 15% 80%, 15% 20%
    );
    border-radius: 30px; /* Increase this value for softer points */
    overflow: hidden; /* Ensures image/logo inside conforms to rounded shape */
  }
