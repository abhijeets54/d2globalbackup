...
const FloatingTestimonials = () => {
  ...
  return (
    <div className="py-12 bg-customBlue flex flex-col h-96 md:h-[550px] lg:h-[50px] justify-center items-center overflow-hidden relative z-0"> {/* Slightly reduced height */}
      {/* Floating Icons */}
