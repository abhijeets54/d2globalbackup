      ...
      { x: '-300px', scale: 0.8 },
      {
        ...
        onComplete: () => {
          gsap.to(plane, {
            ...
            ease: 'power3.inOut',
            onComplete: () => {
              // Move to the next slide as soon as the plane leaves
              if (carouselRef.current) {
                const carouselElement = carouselRef.current;
                const bsCarousel = new window.bootstrap.Carousel(carouselElement, { interval: false }); // Disable automatic sliding
                bsCarousel.next();  // Move to the next slide immediately
              }
            },
          });
        },
