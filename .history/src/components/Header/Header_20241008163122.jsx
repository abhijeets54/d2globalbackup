      ...
      <div className="bg-customBlue py-2 text-customYellow text-sm">
        <div className="container mx-auto flex justify-between items-center px-4 lg:px-8">
          <div className="text-left">
            <p>Email: <a href="mailto:info@d2global.com" className="underline hover:text-yellow-300">info@d2global.com</a></p>
            <p>Phone: <a href="tel:+123456789" className="underline hover:text-yellow-300">+123 456 789</a></p>
          </div>
          <div className="flex space-x-4 items-center text-lg lg:text-xl">
            <a
              href="https://www.facebook.com/profile.php?id=100013114175614&mibextid=LQQJ4d"
              target="_blank"
            ...
            <a
              href="https://snapchat.com/t/oAdKBVHs"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="http://www.youtube.com/@D2Global"
              target="_blank"
              rel="noopener noreferrer"
