...
const CollageWithAnimations = () => {
  ...
  return (
    <div className="relative w-full h-screen shadow- flex flex-col lg:flex-row items-center justify-center bg-gradient-to-r from-gray-50 via-gray-100 to-white">
