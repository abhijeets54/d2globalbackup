...
const FloatingIcon = ({ Icon, left, top }) => (
  <motion.div
    className="absolute text-customYellow opacity-100 z-50"  // Ensuring z-index is higher
...
const FloatingTestimonials = () => {
  ...
  return (
    <div className="py-12 bg-customBlue min-h-fit flex flex-col justify-center items-center overflow-hidden relative z-0">  {/* Added relative and z-0 */}
      {/* Floating Icons */}
