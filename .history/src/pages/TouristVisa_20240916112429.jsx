...
const TouristVisa = () => {
  ...
  const countries = [
    { name: 'Canada', img: '/canada-tourist.jpg', description: 'Explore the scenic beauty of Canada with the help of our tourist visa services.' },
    { name: 'Australia', img: '/australia-tourist.jpg', description: 'Visit Australia’s stunning landscapes by applying for a tourist visa with us.' },
    { name: 'UK', img: '/uk-tourist.jpg', description: 'Discover the historical charm of the UK with our swift visa processing.' },
    { name: 'USA', img: '/usa-tourist.jpg', description: 'Travel to the USA to reconnect with family or explore famous attractions.' },
    { name: 'New Zealand', img: '/newzealand-tourist.jpg', description: 'Plan your adventure in New Zealand, a traveler’s paradise.' },
    { name: 'Europe', img: '/europe-tourist.jpg', description: 'Experience Europe’s rich cultural diversity with our comprehensive visa services.' }
  ];
  ...
  return (
    <div className="bg-gray-100 p-4">
      ...
      {/* Detailed Country Info Section */}
      <motion.div 
        className="p-8 bg-gray-200 mt-6 rounded-lg"
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 1 }}
      >
        <h2 className="text-3xl font-bold mb-4">Canada Tourist Visa</h2>
        <p className="text-lg mb-4">
          At D2 Global, we take pride in helping individuals obtain a tourist visa for Canada quickly and efficiently. Our services include drafting cover letters, processing funds, and guiding clients through the entire visa process.
        </p>
        <h3 className="text-xl font-semibold mb-2">Eligibility Criteria</h3>
        <ul className="list-disc list-inside mb-4 text-lg">
          <li>Proof of financial stability and sufficient funds to cover travel expenses.</li>
          <li>No criminal history and a commitment to follow the nation’s laws.</li>
          <li>A letter of invitation if staying with family or friends.</li>
          <li>Temporary residence visa requirements for specific countries.</li>
        </ul>
        ...
        <ul className="list-disc list-inside text-lg">
          ...
          <li>Evidence of ties to your home country (employment, property, etc.).</li>
          <li>Financial statements showing sufficient funds.</li>
          <li>A medical certificate, if required, demonstrating fitness to travel.</li>
        </ul>
      </motion.div>
