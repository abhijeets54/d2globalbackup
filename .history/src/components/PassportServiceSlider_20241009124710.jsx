    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-left top-16 justify-start">
        <div className="w-1/2 p-8 text-black">
          ...
          <button className={`bg-customBlue text-white px-6 py-2 rounded-full hover:bg-blue-700 transform transition-all duration-500 ease-in-out ${isAnimating ? 'translate-y-5 opacity-0 delay-200' : 'translate-y-0 opacity-100 delay-200'}` onclick = }>
