...
const FloatingTestimonials = () => {
  ...
  return (
    <div className="py-12 bg-customBlue flex flex-col h-auto md:h-[800px] lg:h-[900px] justify-center items-center overflow-hidden relative z-0"> {/* Adjusted height here */}
      {/* Floating Icons */}
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4">
        <div className="flex justify-center items-center h-[600px] md:h-[700px] lg:h-[800px]"> {/* Adjusted heights for different screen sizes */}
