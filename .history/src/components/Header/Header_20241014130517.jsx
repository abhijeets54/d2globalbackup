      ...
      <header className="bg-customBlue text-customYellow py-2">
        <Container>
          <div className="flex justify-between items-center">
            ...
            {/* Contact Info and Social Media - Centered */}
            <div className="flex items-center justify-center flex-grow space-x-10"> {/* Flex-grow to center */}
