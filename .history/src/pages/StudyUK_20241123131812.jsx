...
const StudyUK = () => {
  ...
  <div>
    <h2 className="text-2xl md:text-3xl font-bold mb-4">Living Costs</h2>
    <p className="text-lg">
      Living costs vary based on location and lifestyle. On average:
      <ul className="list-disc list-inside mt-2">
        <li>Inside London: £1,200 to £1,500 per month</li>
        <li>Outside London: £800 to £1,200 per month</li>
      </ul>
    </p>
  </div>
</div>
