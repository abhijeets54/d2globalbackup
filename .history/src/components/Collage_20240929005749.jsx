            ...
            <div className="relative h-screen bg-gradient-to-r from-customBlue to-customYellow">
              <div className="absolute inset-0 flex flex-col justify-center items-center">
                ...
                <div className="text-center text-white px-4 z-20">
                  <h4 className="text-3xl md:text-5xl font-serif font mb-2">Where Your Global Dreams Take Flight</h4>
                  <p className="mb-4 text-lg">Unlock endless opportunities with global education.</p>
                  <p className="text-customYellow text-lg">D2 Global Immigration—your partner in worldwide success.</p>
                </div>
              </div>
            </div>
          </div>
