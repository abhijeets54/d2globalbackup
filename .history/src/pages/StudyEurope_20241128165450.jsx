...
const points = [
  ...
  { title: 'Low Tuition Fees', description: 'Many European universities offer lower fees compared to countries like Australia, the US and Canada. In some cases, there is no tuition fees at all.' },
